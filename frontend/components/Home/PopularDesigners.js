...
function PopularDesigners() {
  return (
    <div className="px-5 sm:px-10 md:px-20 lg:px-10 xl:px-20 py-8 bg-gray-100" id="cards">
                <div className="max-w-screen-xl mx-auto">
                <h3 className="leading-none font-black text-3xl">Our Popular Designers</h3>
                ...
                <div className="lg:flex justify-between lg:mt-8">
                    ...
                    <div className="flex-1 flex w-full max-w-sm pt-16 lg:pt-0">
                        ...
                        <div className="text-lg font-bold text-gray-700 leading-tight">Senior Designer - Adobe Creative Cloud</div>
                        <div>
                            ...
                            <div className="flex items-start">
                                ...
                                <span className="ml-1 text-gray-500">Mombasa - Kenya</span>
                            </div>
                            ...
                            <div className="flex items-start ml-4">
                                ...
                                <span className="ml-1 text-gray-500">Freelance Designer (3 Years)</span>
                            </div>
                            </div>
                            ...
                            <span className="w-5/12 mt-6 mx-1 p-1 rounded bg-blue-200 text-blue-600">3 Years Exp</span>
                            ...
                            <div className="ml-5">
                                ...
                                <div className="text-xs text-gray-500">Open to Jobs</div>
                            </div>
                            </div>
                        </div>
                        </div>
