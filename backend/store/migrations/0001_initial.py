# Generated by Django 3.2.6 on 2022-04-26 15:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pricing', models.CharField(choices=[('FREE', 'FREE'), ('PRO', 'PRO')], default='FREE', max_length=9)),
                ('description', djrichtextfield.models.RichTextField(blank=True, help_text='Not Required', verbose_name='description')),
                ...
                ('quantity', models.IntegerField(default=0, null=0, verbose_name='Product Quantity')),
